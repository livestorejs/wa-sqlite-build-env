...
cp $sqlitelib/sqlite3-opfs-async-proxy.js dist/sqlite3-opfs-async-proxy.js.txt

cat <(echo "export default function install(wrapper, wasmBinaryFileUrl, proxyWorkerFileUrl) {") $sqlitelib/sqlite3.js <(echo "wrapper.self = self; }") > dist/sqlite3.js
...
# sed -i '1s;^;import wasmBinaryFileUrl from "./sqlite3.wasm?url"\n;' dist/sqlite3.js
# sed -i "s|var wasmBinaryFile|// var wasmBinaryFile|g" dist/sqlite3.js
# sed -i "s|wasmBinaryFile = 'sqlite3.wasm';|// wasmBinaryFile = 'sqlite3.wasm';|g" dist/sqlite3.js
sed -i "s|wasmBinaryFile = 'sqlite3.wasm';|wasmBinaryFile = new URL(wasmBinaryFileUrl, import.meta.url).href;|g" dist/sqlite3.js
sed -i "s|.uri = 'sqlite3.wasm'|.uri = new URL(wasmBinaryFileUrl, import.meta.url).href|g" dist/sqlite3.js

# sed -i "s|.uri = 'sqlite3.wasm'|.uri = wasmBinaryFile|g" dist/sqlite3.js
...
sed -i "s|const W = new Worker(options.proxyUri);|const W = new Worker(new URL(proxyWorkerFileUrl, import.meta.url));|g" dist/sqlite3.js
sed -i "s|\"sqlite3-opfs-async-proxy.js\";|new URL(proxyWorkerFileUrl, import.meta.url).href;|g" dist/sqlite3.js
